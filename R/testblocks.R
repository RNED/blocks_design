testblocks = function(TF,replicates=1,rows=NULL,columns=NULL,order=NULL) {
...
#fTF=data.frame( rep(1:2,each=32), rep(rep(1:4,each=8),2), rep(rep(1:4,each=2),8), rep(1:2,32))
#testblocks(fTF)
