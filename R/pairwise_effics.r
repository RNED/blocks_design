...
#'  The tables provide detailed information about a design such as the minimum efficiency of all possible treatment comparisons. 
...
#'  
#' @param Design A design data frame generated by \code{\link{blocks}}
#' 
#' @return  
