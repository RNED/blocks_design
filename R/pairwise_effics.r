...
#'  The tables provide detailed information about the efficiency of all possible treatment comparisons. 
...
#' 
#' @param Design is a design data frame generated by \code{\link[blocksdesign]{blocks}}.
#' 
#' @return  
