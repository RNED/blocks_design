...
#' 
#' @details
#'  Tabulates the efficiency of pairwise treatment difference for each statum of a design built by the \code{blocks} function. 
#'  The table can be extracted for detailed examination of design properties such as the minimum efficiency of all treatment comparisons. 
#'  For equi-replicate designs, the harmonic mean of the pairwise efficiency factors  will equal the A-efficiency factor as calculated by the \code{blocks} function. 
#'  
#' @param Design A block design data frame generated by \code{\link{blocks}}
#' 
#' @return  
