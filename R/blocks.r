...
# ********************************************************************************************************************************************************
  UpDate=function(MTT,MBB,MTB,ti,tj,bi,bj) {  
    ...
    Z1 = (TBbij-TTtij)/f     
    Z2 = (BBbij-TBtij)/f 
    W1 = ( f*(TTtij+TBbij) - (mbb-mtt)*Z1) /d
    W2 = ( f*(TBtij+BBbij) - (mbb-mtt)*Z2) /d
...
# ********************************************************************************************************************************************************     
 ...
 if (  max(treatments)==1 ) AOV= data.frame(Df=c(0,sum(replicates)-1),row.names=c("Treatments","Residuals")) else { 
