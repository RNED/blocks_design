...
#' 
#' @param searches an optional integer for the maximum number of searches during an optimization - default is the maximum of 1 or (100 - sum of model terms).
#' 
#' @param jumps an optional integer for the number of pairwise random treatment swaps used to escape a local maxima in a stratum - 
